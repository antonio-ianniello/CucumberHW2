...
Feature: HomeWork 2 Testing
  ...
  When ho digitato il comando finale "fine"
  ...
  Given Ho iniziato il gioco
  When ho digitato il comando finale "aiuto"
  And avere aspettato la fine della simulazione
  ...
  Given Ho iniziato il gioco
  When ho digitato il comando finale "vai est"
  And avere aspettato la fine della simulazione
  ...
  Given Ho iniziato il gioco
  When ho digitato il comando finale "vai ovest"
  And avere aspettato la fine della simulazione
  ...
  Given Ho iniziato il gioco
  When ho digitato il comando finale "vai nord"
  And avere aspettato la fine della simulazione
  ...
  Given Ho iniziato il gioco
  When ho digitato il comando non finale "vai ovest"
  And ho digitato il comando finale "vai ovest" 
  And avere aspettato la fine della simulazione
  Then il risultato della esecuzione dovrebbe contenere "Aula N11"
 ...
 @tag6
  ...
  Given Ho iniziato il gioco
  When ho digitato il comando non finale "vai est"
  And ho digitato il comando non finale "vai sud"
  And ho digitato il comando finale "vai nord" 
  And avere aspettato la fine della simulazione
  ...
  Given Ho iniziato il gioco
  When ho digitato il comando non finale "prendi chiave"
 	And ho digitato il comando non finale "vai est"
  And ho digitato il comando non finale "vai sud"
  And ho digitato il comando non finale "posa chiave"
  And ho digitato il comando finale "vai nord"
  And avere aspettato la fine della simulazione
  Then il risultato della esecuzione dovrebbe contenere "Aula N11"
